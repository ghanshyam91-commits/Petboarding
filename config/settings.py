...
LANGUAGE_CODE = 'en-in'
LANGUAGES = [('en','English'),('hi','Hindi'),('kn','Kannada'),('ta','Tamil'),('te','Telugu'),('mr','Marathi'),('bn','Bengali')]
...
MIDDLEWARE.insert(MIDDLEWARE.index('django.contrib.auth.middleware.AuthenticationMiddleware'), 'care.middleware.LoginThrottle')
